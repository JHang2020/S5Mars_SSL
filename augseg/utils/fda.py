#FDA (FDA: Fourier Domain Adaptation for Semantic Segmentation) CVPR 2021
import torch
import numpy as np
try:
    ...
    def rfft(x, signal_ndim):
        t = rfft2(x, dim = (-signal_ndim,-1))
        return torch.stack((t.real, t.imag), -1)
    def irfft(x, signal_ndim, signal_sizes):
        return irfft2(torch.complex(x[:,:,0], x[:,:,1]), s = signal_sizes, dim = (-signal_ndim,-1))
